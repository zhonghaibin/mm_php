...
class Page extends Base
{
    ...
    public function getStatusTagAttribute()
    {
        ...
        $route = route('page_show', $this->attributes['id']);

        return $this->attributes['status'] === self::STATUS_DISPLAY ? '<a href="'.$route
            .'" class="btn btn-sm btn-success btn-flat">显示</a>'
            : '<a href="'.$route
            .'" class="btn btn-sm btn-danger btn-flat">隐藏</a>';
    }
