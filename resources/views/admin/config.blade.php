                                ...
                                <div class="tab-pane active" id="tab_1">
                                    <div class="form-group {{$errors->has('site_name')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('site_name'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_name') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_status')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('site_status'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_status') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_close_word')?'has-error':''}}">
                                        ...
                                        <textarea class="form-control" rows="3" name="site_close_word"
                                                  placeholder="输入 ..."
                                                  style="resize: none;">{{ $config['site_close_word'] }}</textarea>
                                        @if ($errors->has('site_close_word'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_close_word') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_info')?'has-error':''}}">
                                        ...
                                        <textarea class="form-control" rows="5" name="site_info" placeholder="输入 ..."
                                                  style="resize: none;">{{ $config['site_info'] }}</textarea>
                                        @if ($errors->has('site_info'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_info') }}</strong></span>
                                        @endif
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab_2">
                                    <div class="form-group {{$errors->has('site_title')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('site_title'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_title') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_keywords')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('site_keywords'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_keywords') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_description')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_description"
                                               id="site_description" value="{{ $config['site_description'] }}">
                                        @if ($errors->has('site_description'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_description') }}</strong></span>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="tab-pane active" id="tab_4">
                                    <div class="form-group {{$errors->has('site_admin')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_admin" id="site_admin"
                                               value="{{ $config['site_admin'] }}"> @if ($errors->has('site_admin'))
                                            <span class="help-block ">
                                        <strong><i
                                                class="fa fa-times-circle-o"></i>{{ $errors->first('site_admin') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_admin_avatar')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_admin_avatar"
                                               ...
                                               value="{{ $config['site_admin_avatar'] }}"> @if ($errors->has('site_admin_avatar'))
                                            <span class="help-block ">
                                        <strong><i
                                                class="fa fa-times-circle-o"></i>{{ $errors->first('site_admin_avatar') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_admin_info')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_admin_info"
                                               id="site_admin_info"
                                               value="{{ $config['site_admin_info'] }}"> @if ($errors->has('site_admin_info'))
                                            <span class="help-block ">
                                        <strong><i
                                                class="fa fa-times-circle-o"></i>{{ $errors->first('site_admin_info') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_mailto_admin')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_mailto_admin"
                                               ...
                                               value="{{ $config['site_mailto_admin'] }}"> @if ($errors->has('site_mailto_admin'))
                                            <span class="help-block ">
                                        <strong><i
                                                class="fa fa-times-circle-o"></i>{{ $errors->first('site_mailto_admin') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_admin_mail')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_admin_mail"
                                               id="site_admin_mail"
                                               value="{{ $config['site_admin_mail'] }}"> @if ($errors->has('site_admin_mail'))
                                            <span class="help-block ">
                                        <strong><i
                                                class="fa fa-times-circle-o"></i>{{ $errors->first('site_admin_mail') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_admin_weibo')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_admin_weibo"
                                               id="site_admin_weibo"
                                               value="{{ $config['site_admin_weibo'] }}"> @if ($errors->has('site_admin_weibo'))
                                            <span class="help-block ">
                                        <strong><i
                                                class="fa fa-times-circle-o"></i>{{ $errors->first('site_admin_weibo') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_admin_github')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_admin_github"
                                               ...
                                               value="{{ $config['site_admin_github'] }}"> @if ($errors->has('site_admin_github'))
                                            <span class="help-block ">
                                        <strong><i
                                                class="fa fa-times-circle-o"></i>{{ $errors->first('site_admin_github') }}</strong>
                                    </span>
                                        @endif
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab_5">
                                    <div class="form-group {{$errors->has('site_icp_num')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('site_icp_num'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_icp_num') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_110beian_num')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_110beian_num"
                                               id="site_110beian_num" value="{{ $config['site_110beian_num'] }}">
                                        @if ($errors->has('site_110beian_num'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_110beian_num') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group {{$errors->has('site_110beian_link')?'has-error':''}}">
                                        ...
                                        <input type="text" class="form-control" name="site_110beian_link"
                                               id="site_110beian_link" value="{{ $config['site_110beian_link'] }}">
                                        @if ($errors->has('site_110beian_link'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('site_110beian_link') }}</strong></span>
                                        @endif
                                    </div>
                                </div>
                                <div class="tab-pane" id="tab_6">
                                    <div class="form-group {{$errors->has('water_mark_status')?'has-error':''}}">
                                        ...
                                        @if ($errors->has('water_mark_status'))
                                            <span class="help-block "><strong><i
                                                        class="fa fa-times-circle-o"></i>{{ $errors->first('water_mark_status') }}</strong></span>
                                        @endif
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="water-mark">
                                            <a data-toggle="modal" href='#water-mark-modal'>
                                                <img class="img-responsive" src="{{ asset('images/water_mark.png') }}"
