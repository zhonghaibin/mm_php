                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group {{$errors->has('author')?'has-error':''}}">
                                    ...
                                    <input type="text" class="form-control" name="author" id="author"
                                           placeholder="在此输入作者"
                                           value="{{old('author') ? old('author') : $page->author}}">
                                    ...
                                    <div class="radio">
                                        <label class="i-checks">
                                            <input type="radio" name="status"
                                                   ...
                                                   @if(!is_null(old('status')) && old( 'status') == \App\Models\Page::STATUS_DISPLAY) checked="checked"
                                                   @elseif($page->status == \App\Models\Page::STATUS_DISPLAY ) checked="checked" @endif>
                                            &nbsp; 是
                                        </label>
                                        <label class="i-checks">
                                            <input type="radio" name="status"
                                                   value="{{ \App\Models\Page::STATUS_HIDE }}"
                                                   @if(!is_null(old('status')) && old( 'status') == \App\Models\Page::STATUS_HIDE) checked="checked"
                                                   @elseif($page->status == \App\Models\Page::STATUS_HIDE ) checked="checked" @endif>
                                            &nbsp; 否
                                        </label>
                                    </div>
                            ...
                            <div class="box-body">
                                <div class=" form-group {{$errors->has('content')?'has-error':''}}">
                                    ...
                                    <textarea name="content" id="mde"
                                              style="display:none;">{{ old('content') ? old('content') : $page->feed->content }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
