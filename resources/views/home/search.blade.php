                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            @else
                                <h3>
                                    为您找到相关结果约{{$articles->count}}个： <span
                                        class="text-blue">“{{request()->input('keyword')}}
                                        ”</span>
                                </h3>
                            @endif
                                ...
                                <form action="{{route('search')}}" method="get">
                                    <div class="input-group">
                                        <input type="text" class="form-control"
                                               placeholder="{{request()->input('keyword')}}" name="keyword">
                            ...
                            @foreach($articles as $article)
                                ...
                                <div class="search-result">
                                    <h3><a href="{{route('article',$article->id)}}"
                                           class="title-link">{{$article->title}}</a></h3>
