...
<div class="wrapper">
    <header class="main-header">
        <a href="{{route('home')}}" class="logo">
            ...
            <span class="logo-lg">蜜蜜妈妈 - 控制台</span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{ \App\Helpers\Extensions\UserExt::getAttribute('avatar') }}" class="user-image"
                        ...
                        <ul class="dropdown-menu">
                            <li class="user-header">
                                <img src="{{ \App\Helpers\Extensions\UserExt::getAttribute('avatar') }}"
                                     class="img-circle"
                                     alt="{{ \App\Helpers\Extensions\UserExt::getAttribute('name') }}">
                                <p>
                            ...
                            <li class="user-body">
                                ...
                                <p>登陆地点
                                    ：{{ \App\Helpers\Extensions\Tool::ip2City( \App\Helpers\Extensions\UserExt::getAttribute('last_login_ip')) }}</p>
                            </li>
    ...
    <aside class="main-sidebar">
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/home') }}"><a
                        href="{{ route('dashboard_home') }}"><i class="fa fa-home"></i> <span> 首页</span></a></li>
                <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/article/create') }}"><a
                        href="{{ route('article_create') }}"><i class="fa fa-pencil-square-o"></i>
                        <span> 新建文章</span></a></li>
                <li class="treeview {{ \App\Helpers\Extensions\Tool::setActive(['admin/config','admin/nav']) }} ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/config/manage') }}"><a
                                href="{{ route('config_manage') }}"><i class="fa fa-cog"></i> 站点设置</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/nav') }}"><a
                                href="{{ route('nav_manage') }}"><i class="fa fa-bars"></i> 菜单管理</a></li>
                    </ul>
                </li>
                <li class="treeview {{ \App\Helpers\Extensions\Tool::setActive(['admin/tag','admin/category','admin/article','admin/page']) }} ">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/tag') }}"><a
                                href="{{ route('article_tag_manage') }}"><i class="fa fa-tags"></i> 标签管理</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/category') }}"><a
                                href="{{ route('category_manage') }}"><i class="fa fa-bars"></i> 栏目管理</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/article') }}"><a
                                href="{{ route('article_manage') }}"><i class="fa fa-file-text"></i> 文章管理</a></li>
                        <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/page') }}"><a
                                href="{{ route('page_manage') }}"><i class="fa fa-file-o"></i> 单页管理</a></li>
                ...
                <li class="{{ \App\Helpers\Extensions\Tool::setActive('admin/operation_logs/manage') }}"><a
                        href="{{ route('operation_logs_manage') }}"><i class="fa fa-history"></i> <span> 日志查看</span></a>
                </li>
            </ul>
        </section>
    </aside>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; {{ date('Y') }} <a href="#">蜜蜜妈妈</a>.</strong> All rights reserved.
    </footer>
</div>
...
<script
    src="https://cdn.jsdelivr.net/combine/npm/jquery-validation@1,npm/jquery-validation@1/dist/localization/messages_zh.min.js"></script>
